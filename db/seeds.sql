  INSERT INTO jobs (creator, job_name, job_description, job_category, budget, email)
  VALUES ("Foo", "Foo Portfolio", "Hello, my name is Foo and I need an online portfolio of my painting work", "Web Design", 200, "foo@gmail.com");
  
  INSERT INTO jobs (creator, job_name, job_description, job_category, budget, email)
  VALUES ("Bob", "Bob's Burgers", "I need a lawyer to defend against a copyright infringement suit", "Legal Services", 1000, "HJonBenjaminFan@gmail.com");
  
  INSERT INTO jobs (creator, job_name, job_description, job_category, budget, email)
  VALUES ("Foo", "Foo's Food Truck app", "I need an interactive mobile app to allow people to order food from their phone for pickup", "Web Design", 2000, "foo@gmail.com");
